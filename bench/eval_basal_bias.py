...
─────────────────────────
EXPERIMENTO r2 — evaluación OFFLINE de la corrección del sesgo basal neto.
...
OUT = os.path.join(os.path.dirname(__file__), "reports", "basal_bias")
...
def main():
    ...
    # ── Salidas ──
    report = {"generated": datetime.now().isoformat(), "model": PROD, "experiment": "r2-basal-net-bias",
    ...
    md = [f"# Experimento r2 — corrección del sesgo basal neto (OFFLINE, {PROD})",
