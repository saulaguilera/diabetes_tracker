...
Modelo: claude-sonnet-5 (vision capable; override con env FOTO_MODEL)
...
# ── Config ────────────────────────────────────────────────────────────────────
# sonnet-4-5 sigue vivo pero es la próxima camada de retiro — migrado
_MODELO        = os.environ.get("FOTO_MODEL", "claude-sonnet-5")
_MAX_TOKENS    = 1400
