...
const DICT = {
  es: {
    ...
    'onb.sensorHint': 'Con tu cuenta de LibreLinkUp (la app de seguidores de FreeStyle Libre), tu glucosa se sincroniza sola. ¿Usás Dexcom o Nightscout? Conectalo después desde Perfil.',
    ...
    'sensor.dexcomHint': 'Usá tu cuenta de Dexcom (con Share activado y al menos un seguidor). Se guarda cifrada.',
    'sensor.nsUrl': 'URL de tu Nightscout (ej: misitio.herokuapp.com)',
    'sensor.nsToken': 'Token de acceso (opcional si el sitio es público)',
    'sensor.nsHint': 'Conectá tu sitio Nightscout: trae tu glucosa Y los bolos de tu bomba (Loop, AndroidAPS, Omnipod DIY) automáticamente.',
  ...
  en: {
    ...
    'onb.sensorHint': 'With your LibreLinkUp account (the FreeStyle Libre followers app), your glucose syncs automatically. On Dexcom or Nightscout? Connect it later from Profile.',
