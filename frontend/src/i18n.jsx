...
const DICT = {
  es: {
    ...
    'onb.basalDose': 'Dosis (U)', 'onb.basalHour': 'Hora habitual (0–23)',
    ...
    'onb.saveError': 'No se pudo guardar. Probá de nuevo.',
  ...
  en: {
    ...
    'onb.basalDose': 'Dose (U)', 'onb.basalHour': 'Usual hour (0–23)',
    ...
    'onb.saveError': "Couldn't save. Try again.",
