...
const DICT = {
  es: {
    ...
    'onb.therapyNote': 'Esto alimenta el recordatorio de basal y el contexto del copiloto. Lo puedes cambiar cuando quieras en Perfil.',
    'onb.sensor': 'Conecta tu sensor',
    'onb.sensorHint': 'Con tu cuenta de LibreLinkUp (la app de seguidores de FreeStyle Libre), tu glucosa se sincroniza sola. Se guarda cifrada.',
    'onb.sensorHelp': '¿Cómo consigo estos datos? Mira la guía →',
    'onb.perfil': '¿Cómo vives la diabetes?',
    'onb.perfilStd': 'Vivo con DT1', 'onb.perfilStdD': 'Mi día a día con diabetes tipo 1',
    'onb.perfilDep': 'Soy deportista', 'onb.perfilDepD': 'Entreno seguido y quiero entender el ejercicio',
    'onb.perfilCui': 'Cuido a alguien', 'onb.perfilCuiD': 'Acompaño a mi hijo/a o familiar con DT1',
    'perfil.vida': 'Tu perfil',
    'perfil.vidaDesc': 'El copiloto adapta su mirada a cómo vives la diabetes.',
    'perfil.helpTitle': 'Centro de ayuda',
    'perfil.helpDesc': 'Cómo conectar tu sensor y sacarle el máximo a Orbit.',
    'onb.saveError': 'Orbit no pudo guardar eso. Probemos de nuevo.',
    'perfil.noDataYet': 'registra comidas e insulina y Orbit lo estima solo',
    'perfil.logout': 'Cerrar sesión',
    // Sensor LibreLinkUp
    'sensor.dexcomUser': 'Usuario Dexcom',
    'sensor.dexcomHint': 'Usa tu cuenta de Dexcom (con Share activado y al menos un seguidor). Se guarda cifrada.',
    'sensor.nsUrl': 'URL de tu Nightscout (ej: misitio.herokuapp.com)',
    'sensor.nsToken': 'Token de acceso (opcional si el sitio es público)',
    'sensor.nsHint': 'Conecta tu sitio Nightscout: trae tu glucosa Y los bolos de tu bomba (Loop, AndroidAPS, Omnipod DIY) automáticamente.',
    'perfil.libre.connected': 'Cuenta LibreLinkUp:',
    'perfil.libre.disconnect': 'Desconectar',
    'perfil.libre.pitch': 'Conecta tu sensor (FreeStyle Libre, Dexcom o Nightscout) para que tu glucosa se sincronice sola.',
    'perfil.libre.connect': 'Conectar',
    'perfil.libre.hint': 'Usa el email y contraseña de tu cuenta LibreLinkUp (la app de seguidores de FreeStyle Libre). Se guardan cifradas y solo se usan para sincronizar.',
    ...
    'perfil.libre.badCreds': 'LibreLinkUp rechazó esas credenciales. Revísalas e intenta de nuevo.',
    ...
    'hoy.basalReminderWhen': 'Sueles aplicarla a las {h}:00',
    ...
    'reg.analyzing1': 'Identificando alimentos…', 'reg.analyzing2': 'Estimando porciones…',
    'reg.analyzing3': 'Calculando macros y fibra…',
    'reg.fiber': 'Fibra', 'reg.fiberHint': 'ya descontada de los carbos',
    'reg.scoreLabel': 'Qué tan amigable es este plato para tu glucosa',
    'reg.estimatedBy': 'Estimado por IA · revisa los valores',
    'reg.changePhoto': 'Cambiar foto', 'reg.reestimate': '↻ Re-estimar con el nombre',
    'reg.lowConfidence': '⚠︎ Confianza baja — revisa bien antes de guardar (o re-estima con el nombre correcto).',
    ...
    'reg.ctxPrompt': '¿Algo que hoy pueda estar moviendo tu glucosa? Márcalo y el copiloto lo tiene en cuenta.',
    ...
    'ev.confirmDel': '¿Seguro que quieres eliminar {noun}? Esta acción no se puede deshacer.',
    ...
    'notif.empty': 'Cuando Orbit encuentre algo nuevo en tus datos, te lo deja aquí 💙',
    // Brief
    'brief.preparing': 'Preparando tu resumen…', 'brief.loadError': 'Orbit no pudo preparar tu resumen todavía. Probemos en un rato.',
    'brief.empty': 'Cuando registres algo hoy, aparece aquí.',
    ...
    'cop.greet3': 'Hola{name} 🌙 Soy tu copiloto: puedo explicarte qué pasó y por qué, y acompañarte en el día a día. ¿Por dónde empezamos?',
    'cop.thinking': 'pensando…', 'cop.analyzing': 'analizando tus datos…',
    'cop.placeholder': 'Pregunta sobre tus datos…', 'cop.basedOnData': '✦ basado en tus datos',
    'cop.newChat': 'Nueva',
    ...
    'pat.note': 'Observaciones de tus datos. Conversa los ajustes con tu equipo médico.',
    // Historial
  ...
  en: {
    ...
    'onb.sensorHint': 'With your LibreLinkUp account (the FreeStyle Libre followers app), your glucose syncs automatically. Stored encrypted.',
    'onb.sensorHelp': 'How do I get these details? See the guide →',
    'onb.perfil': 'How do you live with diabetes?',
    'onb.perfilStd': 'I live with T1D', 'onb.perfilStdD': 'My day-to-day with type 1 diabetes',
    'onb.perfilDep': 'I\'m an athlete', 'onb.perfilDepD': 'I train often and want to understand exercise',
    'onb.perfilCui': 'I\'m a caregiver', 'onb.perfilCuiD': 'I care for my child or a family member with T1D',
    'perfil.vida': 'Your profile',
    'perfil.vidaDesc': 'The copilot adapts its lens to how you live with diabetes.',
    'perfil.helpTitle': 'Help center',
    'perfil.helpDesc': 'How to connect your sensor and get the most out of Orbit.',
    ...
    'sensor.dexcomUser': 'Dexcom username',
    'sensor.dexcomHint': 'Use your Dexcom account (Share enabled with at least one follower). Stored encrypted.',
    'sensor.nsUrl': 'Your Nightscout URL (e.g. mysite.herokuapp.com)',
    'sensor.nsToken': 'Access token (optional if the site is public)',
    'sensor.nsHint': 'Connect your Nightscout site: brings your glucose AND your pump boluses (Loop, AndroidAPS, DIY Omnipod) automatically.',
    'perfil.libre.connected': 'LibreLinkUp account:',
    'perfil.libre.disconnect': 'Disconnect',
    'perfil.libre.pitch': 'Connect your sensor (FreeStyle Libre, Dexcom or Nightscout) so your glucose syncs automatically.',
    ...
    'reg.analyzing1': 'Identifying foods…', 'reg.analyzing2': 'Estimating portions…',
    'reg.analyzing3': 'Calculating macros & fiber…',
    'reg.fiber': 'Fiber', 'reg.fiberHint': 'already subtracted from carbs',
    'reg.scoreLabel': 'How glucose-friendly this meal is',
    ...
    'cop.greet3': "Hi{name} 🌙 I'm your copilot: I can explain what happened and why, and walk with you day to day. Where shall we start?",
